  ...
  return Promise.all([
    ...
    return {
      scenarios: [
        ...
        {
          name: 'ember-lts-3.4-ember-simple-auth-3.1.0-beta',
          npm: {
            dependencies: {
        ...
        {
          name: 'ember-lts-3.8-ember-simple-auth-3.1.0-beta',
          npm: {
            dependencies: {
              'ember-simple-auth': '^3.1.0-beta.1'
            },
        ...
        {
          name: 'ember-lts-3.12-ember-simple-auth-3.1.0-beta',
          npm: {
            dependencies: {
              'ember-simple-auth': '^3.1.0-beta.1'
            },
        ...
        {
          name: 'ember-lts-3.16-ember-simple-auth-3.1.0-beta',
          npm: {
            dependencies: {
              'ember-simple-auth': '^3.1.0-beta.1'
            },
        ...
        {
          name: 'ember-lts-3.20-ember-simple-auth-3.1.0-beta',
          npm: {
            dependencies: {
              'ember-simple-auth': '^3.1.0-beta.1'
            },
        ...
        {
          name: 'ember-lts-3.24-ember-simple-auth-3.1.0-beta',
          npm: {
            dependencies: {
              'ember-simple-auth': '^3.1.0-beta.1'
            },
        ...
        {
          name: 'ember-release-ember-simple-auth-3.1.0-beta',
          npm: {
            dependencies: {
              'ember-simple-auth': '^3.1.0-beta.1'
            },
        ...
        {
          name: 'ember-beta-ember-simple-auth-3.1.0-beta',
          npm: {
            dependencies: {
              'ember-simple-auth': '^3.1.0-beta.1'
            },
        ...
        {
          name: 'ember-canary-ember-simple-auth-3.1.0-beta',
          npm: {
            dependencies: {
              'ember-simple-auth': '^3.1.0-beta.1'
            },
